		...
		private function get_uninstall_reasons() {
			...
			$reasons = array(
				array(
					...
					'text'        => esc_html__( 'I couldn\'t understand how to make it work', 'product-size-chart-for-woo' ),
					'type'        => 'textarea',
					'placeholder' => esc_html__( 'Would you like us to assist you?', 'product-size-chart-for-woo' )
				),
				array(
					'id'          => 'found_better_plugin',
					'text'        => esc_html__( 'I found a better plugin', 'product-size-chart-for-woo' ),
					'type'        => 'text',
					'placeholder' => esc_html__( 'Which plugin?', 'product-size-chart-for-woo' )
				),
				array(
					'id'          => 'not_have_that_feature',
					'text'        => esc_html__( 'The plugin is great, but I need specific feature that you don\'t support', 'product-size-chart-for-woo' ),
					'type'        => 'textarea',
					'placeholder' => esc_html__( 'Could you tell us more about that feature?', 'product-size-chart-for-woo' )
				),
				array(
					'id'          => 'is_not_working',
					'text'        => esc_html__( 'The plugin is not working', 'product-size-chart-for-woo' ),
					'type'        => 'textarea',
					'placeholder' => esc_html__( 'Could you tell us a bit more whats not working?', 'product-size-chart-for-woo' )
				),
				array(
					'id'          => 'looking_for_other',
					'text'        => esc_html__( 'It\'s not what I was looking for', 'product-size-chart-for-woo' ),
					'type'        => 'textarea',
					'placeholder' => 'Could you tell us a bit more?'
				),
				array(
					'id'          => 'did_not_work_as_expected',
					'text'        => esc_html__( 'The plugin didn\'t work as expected', 'product-size-chart-for-woo' ),
					'type'        => 'textarea',
					'placeholder' => esc_html__( 'What did you expect?', 'product-size-chart-for-woo' )
				),
				array(
					'id'          => 'other',
					'text'        => esc_html__( 'Other', 'product-size-chart-for-woo' ),
					'type'        => 'textarea',
					'placeholder' => esc_html__( 'Could you tell us a bit more?', 'product-size-chart-for-woo' )
				),
			);
                ...
                <div class="villatheme-deactivate-modal" id="villatheme-deactivate-survey-modal">
                    <div class="villatheme-deactivate-modal-wrap">
                        <div class="villatheme-deactivate-modal-header">
                            <h3><?php esc_html_e( 'If you have a moment, please let us know why you are deactivating:', 'product-size-chart-for-woo' ); ?></h3>
                        </div>
                        ...
                        <div class="villatheme-deactivate-modal-footer">
                            <a href="#" class="dont-bother-me"><?php esc_html_e( 'I rather wouldn\'t say', 'product-size-chart-for-woo' ); ?></a>
                            <button class="button-primary villatheme-deactivate-submit disabled"><?php esc_html_e( 'Submit & Deactivate', 'product-size-chart-for-woo' ); ?></button>
                            <button class="button-secondary villatheme-model-cancel"><?php esc_html_e( 'Cancel', 'product-size-chart-for-woo' ); ?></button>
                        </div>
                    </div>
                </div>
