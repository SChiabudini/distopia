        ...
        if ($('#woo_sc_hide').val() !== 'hide_all') {
            if ($('#woo_sc_hide').val() !== 'hide_table') {
                ...
                if (arr.length > 0) {
                    ...
                    out += `<div class="woo_sc_table100-body js-pscroll ps ps--active-y"><table class='woo_sc_view_table'><thead class="woo_sc_table100-head "><tr class="woo_sc_row100 head">`;
            ...
            console.log($('input[name="woo_sc_cell_style"]:checked').val())
            ...
            // const ps = new PerfectScrollbar('.woo_sc_modal_backend_content .woo_sc_table_scroll .woo_sc_table100-body.ps');
...
// Remove image event
    ...
    /*$('#woo_sc_table_template').on('change', function () {
           let val = $(this).val(),
               edit_table = $('.woo_sc_table_design');
           edit_table.attr('class', '').addClass('woo_sc_table_design').addClass(val).addClass('woo_sc_table100');
       });*/
