<?php
/*
  Plugin Name: Direct Deposit for WooCommerce
  Plugin URI: http://mindyourownwebsite.com.au
  Description: Modifies the output of WooCommerce BACS settings to suit Australian direct deposit/bank transfer
  Version: 1.1
  Author: Melissa Freeman
  Author URI: http://mindyourownwebsite.com.au
  License: GPLv2+
...
if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
	...
	//        public $domain;
			...
			public function __construct() {
				...
				$this->method_title       = __( 'Customised Direct Deposit', 'woocommerce' );
				...
				if ( ! empty( $bacs_accounts ) ) {
					...
					foreach ( $bacs_accounts as $bacs_account ) {
						...
						$account_fields = apply_filters( 'woocommerce_bacs_account_fields', array(
							...
							'account_name'=> array(
								'label' => __( 'Titular de la cuenta', 'woocommerce' ),
