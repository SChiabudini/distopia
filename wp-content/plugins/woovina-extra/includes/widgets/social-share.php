...
if ( ! class_exists( 'WooVina_Extra_Social_Share_Widget' ) ) {
	class WooVina_Extra_Social_Share_Widget extends WP_Widget {
		...
		public function __construct() {
			// Start up widget
			parent::__construct(
				'woovina_social_share',
				esc_html__( '&raquo; Social Share', 'woovina-extra' ),
				array(
					'classname'   => 'widget-woovina-social-share social-share',
					'description' => esc_html__( 'Display social sharing buttons on your sidebar.', 'woovina-extra' ),
		...
		public function social_array() {
			...
			// Array
			$return = apply_filters( 'woovina_social_share_buttons', array(
				'twitter' => array(
					'name' 	=> 'Twitter',
					'title' => esc_html__( 'Share on Twitter', 'woovina-extra' ),
					'icon'  => '<svg class="wvnss-icon" aria-labelledby="wvnss-twitter-icon" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
				...
				'facebook' => array(
					'name' 	=> 'Facebook',
					'title' => esc_html__( 'Share on Facebook', 'woovina-extra' ),
					'icon'  => '<svg class="wvnss-icon" aria-labelledby="wvnss-facebook-icon" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
				...
				'googleplus' => array(
					'name' 	=> 'Google+',
					'title' => esc_html__( 'Share on Google+', 'woovina-extra' ),
					'icon'  => '<svg class="wvnss-icon" aria-labelledby="wvnss-googleplus-icon" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
				...
				'pinterest' => array(
					'name' 	=> 'Pinterest',
					'title' => esc_html__( 'Share on Pinterest', 'woovina-extra' ),
					'icon'  => '<svg class="wvnss-icon" aria-labelledby="wvnss-pinterest-icon" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
				...
				'linkedin' => array(
					'name' 	=> 'LinkedIn',
					'title' => esc_html__( 'Share on LinkedIn', 'woovina-extra' ),
					'icon'  => '<svg class="wvnss-icon" aria-labelledby="wvnss-linkedin-icon" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
				...
				'viber' => array(
					'name' 	=> 'Viber',
					'title' => esc_html__( 'Share on Viber', 'woovina-extra' ),
					'icon'  => '<svg class="wvnss-icon" aria-labelledby="wvnss-viber-icon" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
				...
				'vk' => array(
					'name' 	=> 'VK',
					'title' => esc_html__( 'Share on VK', 'woovina-extra' ),
					'icon'  => '<svg class="wvnss-icon" aria-labelledby="wvnss-vk-icon" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
				...
				'reddit' => array(
					'name' 	=> 'Reddit',
					'title' => esc_html__( 'Share on Reddit', 'woovina-extra' ),
					'icon'  => '<svg class="wvnss-icon" aria-labelledby="wvnss-reddit-icon" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
				...
				'tumblr' => array(
					'name' 	=> 'Tumblr',
					'title' => esc_html__( 'Share on Tumblr', 'woovina-extra' ),
					'icon'  => '<svg class="wvnss-icon" aria-labelledby="wvnss-tumblr-icon" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
				...
				'viadeo' => array(
					'name' 	=> 'Viadeo',
					'title' => esc_html__( 'Share on Viadeo', 'woovina-extra' ),
					'icon'  => '<svg class="wvnss-icon" aria-labelledby="wvnss-viadeo-icon" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
		...
		public function widget( $args, $instance ) {
			...
			echo $args['before_widget'];
				...
				<ul class="wvn-social-share style-<?php echo esc_attr( $style ); ?> name-<?php echo $social_name ? 'shown' : 'hidden'; ?>">
					<?php
					// Original Array
					...
					foreach( $social_share as $social_key ) {
						...
						echo '<li class="'. esc_attr( $social_key ) .'">';
							...
							echo '<a href="'. $url .'" title="'. esc_attr( $title ) .'" '. wp_kses_post( $add_style ) . ' onclick="wvnShareOnClick( this.href );return false;">';

								echo '<span class="wvn-icon-wrap">';
									echo $icon;
								echo '</span>';

								if( $social_name ) {
									echo '<span class="wvn-social-name">' . $name . '</span>';
								}
		...
		public function form( $instance ) {
			...
			$instance = wp_parse_args( ( array ) $instance, array(
				'title'           	 => esc_attr__( 'Please share this', 'woovina-extra' ),
				'style' 	  		 => esc_html__( 'Minimal', 'woovina-extra' ),
				'border_radius'   	 => '',
				'border_color'   	 => '',
				'bg_color'   	     => '',
				'color'   	         => '',
			...
			<p>
				...
				<select class='widefat' name="<?php echo esc_attr( $this->get_field_name( 'style' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'style' ) ); ?>">
					<option value="minimal" <?php selected( $instance['style'], 'minimal' ) ?>><?php esc_html_e( 'Minimal', 'woovina-extra' ); ?></option>
			...
			<p>
				<label class="color-label" for="<?php echo esc_attr( $this->get_field_id( 'border_color' ) ); ?>"><?php esc_html_e( 'Minimal Style: Border Color', 'woovina-extra' ); ?></label>
			...
			<p>
				<label class="color-label" for="<?php echo esc_attr( $this->get_field_id( 'bg_color' ) ); ?>"><?php esc_html_e( 'Minimal Style: Background Color', 'woovina-extra' ); ?></label>
			...
			<p>
				<label class="color-label" for="<?php echo esc_attr( $this->get_field_id( 'color' ) ); ?>"><?php esc_html_e( 'Minimal Style: Color', 'woovina-extra' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'twitter_username' ) ); ?>"><?php esc_html_e( 'Twitter Username', 'woovina-extra' ); ?>:</label>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id( 'social_name' ); ?>"><?php esc_html_e( 'Show Social Name', 'woovina-extra' ); ?></label>
			</p>

			<h3><?php esc_html_e( 'Social Share','woovina-extra' ); ?></h3>
			<?php
			// Social array
		...
		public function colors( $args, $instance ) {
			...
			if ( $bg_color
				...
				|| $border_color ) : ?>
				<style>
					#<?php echo $id; ?>.widget-woovina-social-share ul li a {
        ...
        public function scripts() {
            ...
            if ( is_active_widget( '', '', 'woovina_social_share' ) ) {
            	wp_enqueue_script( 'oe-social-share', WE_URL . 'includes/widgets/js/share.min.js', array( 'jquery' ), false, true );
            }
        }

	}
}
register_widget( 'WooVina_Extra_Social_Share_Widget' );